...
Todo push no `main` publica. Variáveis na Vercel: `PLATE_RECOGNIZER_TOKEN`, `SUPABASE_URL`, `SUPABASE_KEY`, `SD_CHAVE_BANCO` e, se quiser, `ACCESS_CODE` (código da equipe, pedido uma vez em cada aparelho).
...
Nada é apagado do banco: excluir um atendimento, foto, pessoa, tipo de serviço ou material só tira da lista.
