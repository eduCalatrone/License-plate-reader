...
//   node dev-server.js
//
// Abre em http://localhost:3000 e responde /api/read-plate com o mesmo arquivo
// usado na Vercel (api/read-plate.js). A chave do Plate Recognizer vem do arquivo
// .env nesta pasta (veja .env.exemplo). Sem a chave, o leitor usa a leitura do aparelho.
//
...
const readPlate = require('./api/read-plate.js');
...
const server = http.createServer(async (req, res) => {
  ...
  if (url.pathname === '/api/read-plate') {
